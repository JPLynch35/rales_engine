...
describe 'Invoices API' do
  ...
  context 'GET /api/v1/invoices/find_all?parameters' do
    it 'can find all invoices based on id' do
      create_list(:invoice, 6)
    ...
    it 'can find all invoices based on customer_id' do
      create_list(:customer, 10)
      create(:invoice, customer_id: 4)
      create(:invoice, customer_id: 2)
      create(:invoice, customer_id: 4)

      get '/api/v1/invoices/find_all?customer_id=4'
    ...
    it 'can find all invoices based on merchant_id' do
      create_list(:merchant, 10)
      create(:invoice, merchant_id: 4)
      create(:invoice, merchant_id: 2)
      create(:invoice, merchant_id: 4)

      get '/api/v1/invoices/find_all?merchant_id=4'
    ...
    it 'can find all invoices based on status' do
      create(:invoice, status: 'shipped')
      create(:invoice, status: 'returned')
      create(:invoice, status: 'returned')
    ...
    it 'can find all invoices based on created_at' do
      create(:invoice, created_at: '2012-01-12 09:54:09 UTC')
      create(:invoice, created_at: '2012-03-25 09:54:09 UTC')
      create(:invoice, created_at: '2012-01-12 09:54:09 UTC')

      get '/api/v1/invoices/find_all?created_at=2012-01-12 09:54:09 UTC'
    ...
    it 'can find all invoices based on updated_at' do
      create(:invoice, updated_at: '2012-01-12 09:54:09 UTC')
      create(:invoice, updated_at: '2012-03-25 09:54:09 UTC')
      create(:invoice, updated_at: '2012-01-12 09:54:09 UTC')

      get '/api/v1/invoices/find_all?updated_at=2012-01-12 09:54:09 UTC'
